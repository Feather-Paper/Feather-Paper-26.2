...
paperweight {
    ...
    val feather = forks.register("feather") {
        upstream.patchDir("paperServer") {
            upstreamPath = "paper-server"
            excludes = setOf("src/minecraft", "patches", "build.gradle.kts")
            patchesDir = rootDirectory.dir("feather-server/paper-patches")
...
dependencies {
    implementation(project(":feather-api")) // Leaf - project setup
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "Feather", // Leaf - Rebrand
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Feather", // Leaf - Rebrand
            "Specification-Version" to project.version,
            "Specification-Vendor" to "FeatherMC", // Leaf - Rebrand
            "Brand-Id" to "feathermc:feather", // Leaf - Rebrand
            "Brand-Name" to "Feather", // Leaf - Rebrand
...
tasks.register<Test>("runFeatherTests") {
    group = LifecycleBasePlugin.VERIFICATION_GROUP
    include("**/FeatherTestSuite.class")
    workingDir = temporaryDir
    useJUnitPlatform {
        forkEvery = 1
    }
