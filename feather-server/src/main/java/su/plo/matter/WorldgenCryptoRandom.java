...
public class WorldgenCryptoRandom extends WorldgenRandom {
    ...
    public WorldgenCryptoRandom(int x, int z, Globals.@Nullable Salt typeSalt, long salt) {
        super(net.feathermc.feather.config.modules.opt.FastRNG.enabled ? new net.feathermc.feather.util.math.random.FasterRandomSource(0L) : new LegacyRandomSource(0L));
        if (typeSalt != null) {
