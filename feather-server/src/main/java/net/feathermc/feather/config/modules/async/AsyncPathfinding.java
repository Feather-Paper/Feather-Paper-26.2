...
import net.feathermc.feather.async.path.PathfindTaskRejectPolicy;
...
public class AsyncPathfinding extends ConfigModules {
    ...
    public void onLoaded() {
        ...
        if (enabled) {
            FeatherConfig.LOGGER.info("Using {} threads for Async Pathfinding", asyncPathfindingMaxThreads);
            net.feathermc.feather.async.path.AsyncPathProcessor.init();
        }
    }
}
