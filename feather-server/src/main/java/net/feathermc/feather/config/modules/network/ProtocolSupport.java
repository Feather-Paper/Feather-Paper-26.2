package net.feathermc.feather.config.modules.network;

import net.feathermc.feather.config.ConfigModules;
import net.feathermc.feather.config.EnumConfigCategory;
import net.feathermc.feather.protocol.DoABarrelRollPackets;
import net.feathermc.feather.protocol.DoABarrelRollProtocol;
