package net.feathermc.feather.world;
...
import net.feathermc.feather.config.modules.gameplay.IceAndSnowChance;
...
public final class RandomTickSystem {
    ...
    public void tick(ServerLevel world) {
        ...
        if (net.feathermc.feather.config.modules.opt.MutableBlockPos.enabled) {
