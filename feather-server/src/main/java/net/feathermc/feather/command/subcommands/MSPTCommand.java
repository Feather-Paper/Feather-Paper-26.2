...
import net.feathermc.feather.config.modules.async.SparklyPaperParallelWorldTicking;
...
public final class MSPTCommand extends PermissionedFeatherSubcommand {
