package net.feathermc.feather.misc;
...
public class LagCompensation {
    ...
    public static int fluidDelay(Level level, BlockPos pos, int rawDelay, boolean enabledForThisFluid, TagKey<Fluid> oppositeTag) {
        return net.feathermc.feather.config.modules.misc.LagCompensation.enabled && enabledForThisFluid && !isTouchingFluid(level, pos, oppositeTag)
            ? tt20(rawDelay, true)
            : rawDelay;
    }
