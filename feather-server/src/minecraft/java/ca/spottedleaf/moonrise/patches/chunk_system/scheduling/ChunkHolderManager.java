...
public final class ChunkHolderManager {
    ...
    public final net.feathermc.feather.world.ChunkCache<NewChunkHolder> chunkHoldersNoSync; // Leaf - thread unsafe chunk map
    ...
    public ChunkHolderManager(final ServerLevel world, final ChunkTaskScheduler taskScheduler) {
        ...
        this.chunkHoldersNoSync = new net.feathermc.feather.world.ChunkCache<>(world.getChunkSource().mainThread); // Leaf - thread unsafe chunk map
    }
    ...
    void addChangedStatuses(final List<NewChunkHolder> changedFullStatus) {
        ...
        if (net.feathermc.feather.config.modules.async.SparklyPaperParallelWorldTicking.enabled && !TickThread.isTickThreadFor(world) || !TickThread.isTickThread()) { // Leaf - SparklyPaper - parallel world ticking
    ...
    public boolean processTicketUpdates() {
        ...
        final boolean isTickThread = net.feathermc.feather.config.modules.async.SparklyPaperParallelWorldTicking.enabled ? TickThread.isTickThreadFor(world) : TickThread.isTickThread(); // Leaf - SparklyPaper - parallel world ticking
