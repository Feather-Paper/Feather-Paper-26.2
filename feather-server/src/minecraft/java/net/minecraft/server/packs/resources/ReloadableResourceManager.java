...
public class ReloadableResourceManager implements AutoCloseable, ResourceManager {
    ...
    public ReloadInstance createReload(
        ...
        return SimpleReloadInstance.create(this.resources, this.listeners, backgroundExecutor, mainThreadExecutor, initialTask, !net.feathermc.feather.util.LeafConstants.DISABLE_VANILLA_PROFILER); // Leaf - Configurable vanilla profiler
    }
