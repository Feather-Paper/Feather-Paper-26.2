...
public class FetchProfileCommand {
    ...
    private static void reportResolvedProfile(
        final CommandSourceStack sender, final String messageId, final Component argument, final ResolvableProfile profile
    ) {
