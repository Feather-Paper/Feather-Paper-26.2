...
public class PerlinNoise {
    ...
    private final double [] amplitudesArray; // Gale - C2ME - optimize noise generation
    ...
    protected PerlinNoise(final RandomSource random, final Pair<Integer, DoubleList> pair, final boolean useNewInitialization) {
        ...
        this.amplitudesArray = this.amplitudes.toDoubleArray(); // Gale - C2ME - optimize noise generation
    }
    ...
    public static double wrap(final double x) {
        return x - Math.floor(x / 3.3554432E7 + 0.5) * 3.3554432E7; // Gale - C2ME - optimize noise generation
    }
