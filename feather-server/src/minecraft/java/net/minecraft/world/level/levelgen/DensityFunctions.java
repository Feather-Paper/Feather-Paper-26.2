...
public final class DensityFunctions {
    ...
    protected static final class EndIslandDensityFunction implements DensityFunction.SimpleFunction {
        ...
        public EndIslandDensityFunction(final long seed) {
            RandomSource islandRandom = net.feathermc.feather.config.modules.opt.FastRNG.worldgenEnabled() ? new net.feathermc.feather.util.math.random.FasterRandomSource(seed) : new LegacyRandomSource(seed); // Leaf - Faster random generator
    ...
    private record IntervalSelect(DensityFunction input, DoubleList thresholds, List<DensityFunction> functions) implements DensityFunction {
        ...
        public static final KeyDispatchDataCodec<DensityFunctions.IntervalSelect> CODEC = KeyDispatchDataCodec.of(DATA_CODEC);
    ...
    public static final class Spline implements DensityFunction {
        ...
        public boolean equals(final Object obj) {
            return obj == this || obj instanceof DensityFunctions.Spline splineFunction && this.spline.equals(splineFunction.spline);
        }
