...
public class DualNoiseProvider extends NoiseProvider {
    ...
    public DualNoiseProvider(
        ...
        this.slowNoise = NormalNoise.create(new WorldgenRandom(net.feathermc.feather.config.modules.opt.FastRNG.worldgenEnabled() ? new net.feathermc.feather.util.math.random.FasterRandomSource(seed) : new LegacyRandomSource(seed)), slowNoiseParameters); // Leaf - Faster random generator
    }
