...
public class CombatTracker {
    ...
    public CombatTracker(final LivingEntity mob) {
        ...
        this.entries = net.feathermc.feather.config.modules.fixes.MCBugFix.mc301114 ? new net.feathermc.feather.util.list.EvictingRingList<>(net.feathermc.feather.config.modules.fixes.MCBugFix.mc301114maxCombatEntries) : new net.minecraft.util.ArrayListDeque<>(); // Paper - Fix mem leak (MC-301114); Use ArrayListDeque // Leaf - Fix MC-301114 Combat Tracker memory leak
    }
    ...
    public void recordDamage(final DamageSource source, final float damage) {
        ...
        this.recordDamageAndCheckCombatState(entry);
    }
    ...
    public void recordDamageAndCheckCombatState(final CombatEntry entry) {
        ...
        if (!net.feathermc.feather.config.modules.fixes.MCBugFix.mc301114) { // Leaf - Fix MC-301114 Combat Tracker memory leak
        ...
        } // Leaf - Fix MC-301114 Combat Tracker memory leak
