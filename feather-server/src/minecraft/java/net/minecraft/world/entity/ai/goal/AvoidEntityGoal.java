...
public class AvoidEntityGoal<T extends LivingEntity> extends Goal {
    ...
    private final int leaf$internal = Math.max(1, reducedTickDelay(net.feathermc.feather.config.modules.opt.EntityGoal.chanceAvoidEntity)); private int leaf$counter; // Leaf - configurable goal update interval
    @Override
