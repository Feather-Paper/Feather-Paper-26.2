...
public class DismountHelper {
    ...
    public static VoxelShape nonClimbableShape(final BlockGetter level, final BlockPos pos) {
        ...
        return ((blockState.tagFlag & (net.feathermc.feather.util.BlockMasks.TRAP_DOOR_CL_OPEN | net.feathermc.feather.util.BlockMasks.CLIMBABLE_TAG)) == 0) // Leaf - Cache block state tags
