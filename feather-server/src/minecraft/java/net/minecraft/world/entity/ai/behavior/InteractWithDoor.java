...
public class InteractWithDoor {
    ...
    private static boolean isDoorTooFarAway(final ServerLevel level, final LivingEntity body, final GlobalPos doorGlobalPos) {
        return doorGlobalPos.dimension() != level.dimension()
            || !doorGlobalPos.pos().closerToCenterThan(body.position(), SKIP_CLOSING_DOOR_IF_FURTHER_AWAY_THAN);
    }
