...
public class SynchedEntityData {
    ...
    public <T> SynchedEntityData.DataItem<T> getItem(final EntityDataAccessor<T> accessor) {
    ...
    public @Nullable List<SynchedEntityData.DataValue<?>> packDirty() {
        ...
        ArrayList<SynchedEntityData.DataValue<?>> result = new ArrayList<>(count);
    ...
    public List<SynchedEntityData.DataValue<?>> packAll() {
        final List<SynchedEntityData.DataValue<?>> values = new ArrayList<>(this.itemsById.length);
