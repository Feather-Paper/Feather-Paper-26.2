...
public record ServerboundChatPacket(String message, Instant timeStamp, long salt, @Nullable MessageSignature signature, LastSeenMessages.Update lastSeenMessages)
    ...
    private void write(final FriendlyByteBuf output) {
        ...
        if (net.feathermc.feather.config.modules.network.ChatMessageSignature.enabled) output.writeNullable(this.signature, MessageSignature::write); // Leaf - Mirai - Configurable chat message signatures
