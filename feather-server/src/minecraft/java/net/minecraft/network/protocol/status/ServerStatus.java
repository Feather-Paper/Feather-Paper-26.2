...
public record ServerStatus(
    ...
    public static final Codec<ServerStatus> CODEC = RecordCodecBuilder.create(
        ...
        i ->
            net.feathermc.feather.config.modules.network.ChatMessageSignature.enabled
            ? i.group(
